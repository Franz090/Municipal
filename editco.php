...
$department = $_POST['department'];
    ...
    if(empty($obrno) || empty($dvno) || empty($checkno)) {				
        ...
        //updating the table
        $result = mysqli_query($mysqli, "UPDATE viewco SET name=
...
$result = mysqli_query($mysqli, "SELECT * FROM viewco WHERE id=$id");
...
<body>
    <a href="index.php">Home</a> | <a href="viewco.php">View viewco</a> | <a href="logout.php">Logout</a>
    <br/><br/>
